...
bool chimera::evoapprox8u::MutatorEvoApprox8u::getMatchedNode(const NodeType &node,
...
///         operation
StatementMatcher chimera::evoapprox8u::MutatorEvoApprox8u::getStatementMatcher()
{
...
bool chimera::evoapprox8u::MutatorEvoApprox8u::match(const NodeType &node)
{
...
Rewriter &chimera::evoapprox8u::MutatorEvoApprox8u::mutate(const NodeType &node,
                                                        MutatorType type,
                                                        Rewriter &rw)
{
  ...
  do
  {
    ...
    ::std::string nabId = "evoApprox8u_component_" + ::std::to_string(bopNum++);
    ...
    MutatorEvoApprox8u::MutationInfo mutationInfo;
...
void chimera::evoapprox8u::MutatorEvoApprox8u::onCreatedMutant(
  const ::std::string &mDir)
{
  ...
  while (!(this->mutationsInfo.empty()))
  {
    ...
    MutatorEvoApprox8u::MutationInfo mutationInfo = this->mutationsInfo.back();
