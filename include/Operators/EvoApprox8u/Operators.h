...
#ifndef INCLUDE_OPERATORS_EVOAPPROX8U_OPERATORS_H
#define INCLUDE_OPERATORS_EVOAPPROX8U_OPERATORS_H
...
::std::unique_ptr<::chimera::m_operator::MutationOperator> getEvoApprox8uOperator();
/// \}
